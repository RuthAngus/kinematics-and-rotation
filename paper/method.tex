...
with {\it detectable} rotation periods are included in it.
Since lower-mass stars stay active for longer it is likely that the oldest
stars in this sample have low masses.
...
At a galactic latitude of zero, $v_b=v_z$, however for increasing values of
...
a limiting magnitude of 16 dex.
...
themselves, we also compared the \vb\ and \vz\ velocity dispersions for stars
downloaded from the GUMS simulation.
