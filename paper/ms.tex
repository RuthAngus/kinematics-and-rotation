% zip files.zip ms.tex abstract.tex intro.tex method.tex results.tex conclusion.tex acknowledgements.tex appendix.tex CMD_cuts_double.pdf main_figure.pdf gap.pdf vb_vs_teff.pdf vb_vz.pdf field_comparison.pdf bib.bib ms.pdf
