% zip all_in_one.zip one_big_file.tex CMD_cuts_double.pdf main_figure.pdf gap.pdf vb_vs_teff.pdf vb_vz.pdf field_comparison.pdf bib.bib ms.pdf
...
\section{Appendix: Validating \vb\ dispersion as an age proxy}
