...
Figure \ref{fig:vplot} shows rotation period versus effective temperature for
...
Figure \ref{fig:masses_with_models} shows the same as figure \ref{fig:vplot},
...
These results indicate that stars of spectral type ranging from late G to late
K follow a braking law that changes over time.
...
The explanation for this, according to the \citet{spada2019} model, is that
