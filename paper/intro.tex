...
because its velocity depends on its position in orbit, however the velocity
{\it dispersion} of a {\it group} of stars will indicate whether that group is
old or young relative to other groups.
...
% and the Sun.  The large number of Praesepe members with precise rotation
% periods from the
