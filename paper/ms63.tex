...
Most semi-physical spin-down models predict that, once the rotation periods of
stars converge to a tight sequence, they approximately spin down with a common
braking index \citep[e.g., Fig. 5 in][]{gallet2015}.
While some semi-physical models do not predict that stars have fully converged
...
6811, NGC 752, and Ruprecht 147][Curtis \etal, submitted]{curtis2019,
agueros2018} demonstrate that the assumptions adopted in those models must be
invalid, or inaccurate in some quantitative way (for example, the
core-envelope coupling timescale is inaccurately calibrated).
...
models do not reproduce the data, since tensions with
\citet{skumanich1972}-type spin-down have been revealed whenever new rotation
periods of benchmark stars have become available.
With the influx of new stellar rotation periods provided by \kepler/\ktwo\ and
\tess, our understanding of spin-down is changing rapidly.
...
sophisticated models incorporating additional physical effects \citep[\eg,
core-envelope coupling][]{spada2019} over simple empirical models.
